...
$acc_username = "Jenicamendoza23";
$acc_password = "07Perlas23";
$acc_fullname = "Jenica Mendoza ";
...
//get the username and password from the form and compare to the predefined username and password
	...
	//tama and username pero mali ang password
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-5">
                 ...
                 if(isset($_REQUEST['notexist'])===true){
                       echo "<div class='alert-danger' role='alert'> Username does not exist... </div>";
                 }else if (isset($_REQUEST['wrongpass'])===true){
                 	     echo "<div class='alert-warning' role='alert'> Incorrect Password... </div>";
                 }else if (isset($_REQUEST['success']) === true){
                 	     echo "<div class='alert-success' role='alert'> Redirecting... </div>";

                 	header ("Refresh: 5; url=account.php");

                 }else if (isset($_REQUEST['logout'])===true){

                 	echo "<div class='alert-info' role='alert'> Thank You... </div>";

                 } else if (isset($_REQUEST['logfirst'])===true){
                 	echo "<div class='alert-info' role='alert'> Please Login First... </div>";
                 } else if (isset($_SESSION['ses_username'])===true){
                 	echo "<div class='alert-warning' role='alert'> You are still logged in. Please <a href='account.php'> click here click here </a> to proceed... </div>";
                 }
